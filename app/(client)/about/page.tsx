...
const AboutUs = () => {
  return (
    <div className="-mr-4 relative w-screen h-full">
      <Image
        src={
          "https://res.cloudinary.com/dcfwqisy1/image/upload/v1706462172/GenerationsRecipes/AboutBG.jpg"
        }
        alt="about bg"
        fill
        className="absolute top-2 left-0 object-cover aspect-square"
      />
      <div className="p-4 backdrop-blur-sm bg-white/60 w-screen h-full">
        <div className="max-w-3xl mx-auto mb-4">
          <h1 className="text-2xl font-semibold">קצת עלינו</h1>
          <p className="text-base">
            ברוכים הבאים ל-מתכוני דורות! ב-מתכוני דורות, אנו נלהבים
          ...
          <p className="text-base">
            מהמשפחה שלנו לשלך, צוות מתכוני דורות
          </p>
        </div>
      </div>
    </div>
